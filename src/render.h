...
private:
    ...
    [[nodiscard]] io2d::interpreted_path PathFromWay(const Model::Way &way) const;

    [[nodiscard]] io2d::interpreted_path PathFromMP(const Model::Multipolygon &mp) const;

    [[nodiscard]] io2d::interpreted_path PathLine() const;
