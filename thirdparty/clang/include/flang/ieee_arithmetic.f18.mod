...
type(ieee_round_type),parameter::ieee_to_zero=ieee_round_type(mode=0_1)
type(ieee_round_type),parameter::ieee_nearest=ieee_round_type(mode=1_1)
type(ieee_round_type),parameter::ieee_up=ieee_round_type(mode=2_1)
type(ieee_round_type),parameter::ieee_down=ieee_round_type(mode=3_1)
type(ieee_round_type),parameter::ieee_away=ieee_round_type(mode=4_1)
type(ieee_round_type),parameter::ieee_other=ieee_round_type(mode=5_1)
interface operator(==)
