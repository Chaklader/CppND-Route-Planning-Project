!mod$ v1 sum:ea4f8ac413bbdecf
module omp_lib
integer(4),parameter::omp_integer_kind=4_4
intrinsic::selected_int_kind
integer(4),parameter::omp_logical_kind=1_4
...
integer(1)::omp_is_initial_device
end
end interface
interface
